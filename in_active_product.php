<?php
  ...
  $products = join_in_active_product_table();
?>
                  ...
                  <!-- NAV BAR -->
                      <nav class="navbar navbar-expand-lg border-bottom">
                          <div class="container-fluid">
                              <h4 class="text-uppercase">Not Active Products</h4>
                      ...
                      <div class="container-fluid mb-5 mainBar">
                        <div class="bg-body py-4 px-5 bg-body rounded shadow-lg">
                            ...
                            <div class="div text-end">
                                <a href="product.php" role="button" class="btn rounded-0 px-4 me-3" style="border-bottom: 1px solid #F48C06 !important; color: #F48C06">Active Product</a>
                            ...
                            <div class="row mt-2">
                                      ...
                                      <div class="col-md-7">
                                        <div class="card-body pt-4" style="line-height:15px;">
                                          ...
                                          <div class="row text-center mb-1 g-0 mx-3">
                                            ...
                                            <div class="col-6 mx-auto">
                                                <a role="button" style="background-color:#F48C06; color:#fff !important;" type="button" onclick="enableProduct(<?php echo (int)$product['common_id'];?>)" class="btn btn-sm rounded-0 px-4 py-2">ENABLE</a>
                                            </div>
                                            <!-- <div class="col-6 mx-auto ">
                              ...
                              <?php else: ?>
                                <div class="text-center">
                                    <H5 class="my-5 text-uppercase text-dark">No not active products found.</H5>
                                </div>
                              <?php endif; ?>
                            </div>
                        </div>
                  ...
                  <script>
                      ...
                      function enableProduct(id){
                        Swal.fire({
                            ...
                            Swal.fire({
                                title: 'Change Status',
                                text: "Product was ENABLE successfully",
                                icon: 'success',
                                showConfirmButton: false,
                                timer: 1500,
                            }).then((result) => {
