                    ...
                    <div class="container-fluid mb-5 mainBar">
                      <div class="bg-body py-4 px-5 bg-body rounded shadow-lg">
                          ...
                          <ul class="nav nav-tabs mb-4">
                              ...
                              <li class="nav-item">
                                  <a class="nav-link" href="all_deactivate_user.php">Not Active</a>
                              </li>
                                  ...
                                  <?php foreach($all_users as $a_user): ?>
                                    <tr>
                                      ...
                                      <td class="text-center col-2">
                                        ...
                                        <button type="button" data-toggle="tooltip" title="Deactivate" onclick="deactivateUser(<?php echo (int)$a_user['id'];?>)" class="btn btn-xs btn-outline-danger rounded-0"><i class="bi bi-trash3"></i></button>
                                      </td>
                                    </tr>
                                  <?php endforeach;?>
                                </tbody>
    ...
    <script>
        ...
        function deactivateUser(id){
          ...
          Swal.fire({
              ...
              text: "User was deactivate successfully",
              icon: 'success',
              showConfirmButton: false,
              timer: 1500,
          }).then((result) => {
